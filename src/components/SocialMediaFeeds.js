...
import '../styles/SocialMediaFeeds.css';
...
const socialMediaLinks = [
  ...
  {
    name: 'Twitter',
    url: 'https://twitter.com/the1975',
    icon: (
      <svg width="24" height="24" fill="#00ffea" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M22.46 6c-.77.35-1.6.58-2.46.69a4.3 4.3 0 001.88-2.37 8.59 8.59 0 01-2.72 1.04 4.28 4.28 0 00-7.3 3.9A12.14 12.14 0 013 4.89a4.28 4.28 0 001.32 5.71 4.24 4.24 0 01-1.94-.54v.05a4.28 4.28 0 003.44 4.2 4.3 4.3 0 01-1.93.07 4.28 4.28 0 003.99 2.97A8.6 8.6 0 012 19.54a12.13 12.13 0 006.56 1.92c7.88 0 12.2-6.53 12.2-12.2 0-.19 0-.37-.01-.56A8.7 8.7 0 0022.46 6z"/>
      </svg>
    ),
  },
  {
    name: 'Facebook',
    url: 'https://facebook.com/the1975',
    icon: (
      <svg width="24" height="24" fill="#00ffea" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
